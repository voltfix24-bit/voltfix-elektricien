...
- [ ] Stap 4: datum + dagdeel, volledige adresaanvulling en compacte mobiele weergave; NL/EN-QA op 360, 390, 1024 en 1440px.
...
- [x] Mobiele footerstatus en route-afhankelijke succesteksten gecontroleerd op de gevraagde NL/EN-schermen.
