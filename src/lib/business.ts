  ...
  team: [
    {
      ...
      credentials: [
        {
          id: "vca-cert",
          name: "VCA Veiligheid voor Operationeel Leidinggevenden (VOL-VCA)",
          issuer: "NIKTA (Nederlands Instituut voor Kwaliteitszorg Training en Advies)",
        ...
        {
          id: "bei-bhs-cert",
          name: "BEI BHS AVP MS Distributie",
          issuer: "Stipel",
          issuerType: "Organization" as const,
          category: "certification" as const,
        },
        ...
        {
          id: "mbo4-engineering-cert",
          name: "Middenkader Engineering Installatietechniek (mbo niveau 4)",
          issuer: "ROC van Amsterdam | Flevoland",
          issuerType: "EducationalOrganization" as const,
          category: "degree" as const,
        ...
        {
          id: "mbo3-cert",
          name: "Eerste Monteur Laag- en Middenspanningsdistributie (mbo niveau 3)",
          issuer: "Graafschap College",
          issuerType: "EducationalOrganization" as const,
          category: "degree" as const,
      ...
      alumniOf: [
        { name: "Deltion College", url: "https://www.deltion.nl/" },
        { name: "ROC van Amsterdam | Flevoland", url: "https://www.rocva.nl/" },
        { name: "Graafschap College", url: "https://www.graafschapcollege.nl/" },
      ],
