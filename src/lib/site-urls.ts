...
export const SITE_ENTRIES: SitemapEntry[] = [
  ...
  { path: "/perilex-amsterdam", changefreq: "monthly", priority: "0.9", lastmod: "2026-09-13" },
  { path: "/perilex-stekker", changefreq: "monthly", priority: "0.7", lastmod: "2026-09-13" },
  ...
  { path: "/en-gb/perilex-amsterdam", changefreq: "monthly", priority: "0.8", lastmod: "2026-09-13" },
