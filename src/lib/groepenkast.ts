...
export function groupFaqs(lang: GroupLocale) {
  ...
  return en ? [
    ...
    { q: 'I rent my home or live in a building with a VvE. Can I request this?', a: 'Yes, but check permission first. Tenants need written approval from the landlord or housing association, because the fuse box is part of the property. In an apartment with a VvE (owners’ association), the fuse box inside your own home is usually private, while the meter cupboard, risers and communal installation belong to the association. We replace the private board; anything in the communal installation needs the VvE’s approval first.' },
  ] : [
