...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. All work is delivered to the NEN 1010 standard with a written warranty on labour and installed materials. VoltFix is KvK-registered (91447127) and fully insured.",
  },
  {
    ...
    scripts: [
      ldScript(
        serviceSchema({
          ...
          description: `English-speaking electrician in ${area} — emergencies, fuse boxes, perilex, EV chargers and NEN 1010/3140 inspections across ${neighborhoods.join(", ")}.`,
          path: enPath,
        }),
      ),
