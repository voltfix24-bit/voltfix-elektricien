...
const faqs = [
  {
    q: `Do you serve all of ${area}, including Zuidas and Apollobuurt?`,
    a: `Yes. We work daily across ${area} — from Rivierenbuurt and Oud-Zuid to Zuidas offices. For emergencies we're often on site within 30–45 minutes.`,
  },
  {
    ...
    >
      <Prose>
        <p>
          ...
          complete electrical installations across Apollobuurt, Rivierenbuurt, Oud-Zuid and the
          Zuidas.
        </p>
        <h2>What we handle in {area}</h2>
        <ul>
          <li>24/7 emergency electrician — short circuits, tripped RCDs, power loss</li>
          <li>Fuse box replacement in classic 1930s homes and modern Zuidas apartments</li>
          <li>Perilex sockets (400V) for induction hobs and ovens</li>
          <li>EV charger installation at home or shared parking (VvE)</li>
          <li>NEN 1010 &amp; NEN 3140 inspections for homes, rentals and offices</li>
        </ul>
        <h2>How we work</h2>
        <p>
          Every job starts with a clear scope and a fixed price agreed up front. We arrive on time,
          leave the space clean, and deliver a written warranty on labour and materials — all
          handled in English.
        </p>
      </Prose>
