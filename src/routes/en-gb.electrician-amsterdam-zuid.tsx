...
const faqs = [
  ...
  },
  {
    ...
    a: `Yes. All work is delivered to the NEN 1010 standard with a written warranty on labour and installed materials. VoltFix is KvK-registered (${business.kvk}) and fully insured.`,
  },
  {
...
export const Route = createFileRoute("/en-gb/electrician-amsterdam-zuid")({
  head: () => ({
    meta: pageMeta({
      ...
      description: `English electrician in ${area} — Apollobuurt, Rivierenbuurt, Zuidas (${postcodes}). NEN 1010, fixed price, 24/7 emergency.`,
      path: enPath,
