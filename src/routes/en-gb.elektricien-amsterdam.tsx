...
function Page() {
  return (
    ...
    >
      <Prose>
        <p>
          Finding a good <strong>electrician in Amsterdam</strong> who responds
          fast, communicates honestly and delivers quality work — that's what
          VoltFix stands for. Whether it's an acute fault, a new fuse box or extra
          sockets, we help you safely and with a fixed price agreed up front. We
          work in English, so expats can rely on us too.
        </p>

        <h2>Emergency electrician in Amsterdam</h2>
        <p>
          No power or a short circuit? Our <strong>emergency electrician</strong>{" "}
          is available 24/7 — including evenings, weekends and public holidays.
          For emergencies we're often on site within 30 to 60 minutes in Amsterdam
          to trace the cause and get your power safely back on.
        </p>
        ...
        <p>
          We know the city, its buildings and Amsterdam's fuse boxes — from the
          canal houses in the centre to the apartments on IJburg. That means we
          reach you quickly and know exactly what to look out for in both older and
          newer homes.
        </p>

        <h2>Transparent rates and a warranty</h2>
        <p>
          You always get a fixed price agreed up front, so you're never faced with
          surprises. All our work is carried out to the NEN 1010 standard and we
          provide a warranty on completed work and installed materials. Call us or
          send a WhatsApp with your question and address in Amsterdam, and we'll
          take it from there.
        </p>
      </Prose>
    </ServicePage>
