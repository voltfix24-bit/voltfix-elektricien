...
function Page() {
  return (
    ...
    >
      <Prose>
        <p>
          An electrical fault always strikes at the worst moment. Whether it's the
          middle of the night, while cooking or just as you're working from home —
          without power, the whole household grinds to a halt.{" "}
          <strong>VoltFix is your emergency electrician in Amsterdam</strong>,
          available 24 hours a day, 7 days a week. We're on site fast, trace the
          cause and make sure you have safe power again.
        </p>
        ...
        <ul>
          <li>
            <strong>A short circuit</strong> where the power keeps cutting out or a
            circuit won't stay on.
          </li>
          <li>
          ...
          <li>
            <strong>A burning smell, sparks or a hot fuse box</strong> — always
            acutely dangerous.
          </li>
          <li>
            <strong>Failure of key appliances</strong> such as the boiler, fridge
            or security system.
          </li>
        </ul>
        ...
        <p>
          VoltFix is a local electrician and knows Amsterdam inside out. Whether
          you live in Centrum, Zuid, West, Oost, Noord, De Pijp, the Jordaan or on
          IJburg — our electricians are usually with you within 30 to 60 minutes.
          We arrive in a fully equipped van, so we can resolve most faults on the
          first visit. No unnecessary second appointment, just a solution.
        </p>

        <h2>Transparent rates, even for emergencies</h2>
        <p>
          With VoltFix, an emergency doesn't mean an unclear bill afterwards. We
          work with clear call-out fees and a fixed hourly rate, and always discuss
          the price up front. So you know exactly where you stand, even if we come
          in the evening or at the weekend. Need an electrician urgently in
          Amsterdam right now? Call directly, or send us a WhatsApp with a short
          description and your address.
        </p>
      </Prose>
    </ServicePage>
  );
