...
export const attachmentCopy = {
  nl: {
    ...
    hint: 'JPG, PNG, WebP of PDF · max. 8 bestanden. Een iPhone-foto (HEIC) zetten we in je browser om naar JPG.',
  ...
  en: {
    ...
    addPhoto: 'Add photo',
    addFile: 'File or PDF',
    hint: 'JPG, PNG, WebP or PDF · up to 8 files. An iPhone photo (HEIC) is converted to JPG in your browser.',
